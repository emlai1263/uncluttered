          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <input
                ...
                className="justify-center border p-2  w-full max-w-md"
              />
              <p name="pwdnote" className={passwordFocus && !validPassword ? "instructions" : "offscreen"}>
              ...
              />
              <p id="confirmnote" className={confirmPassFocus && !validConfirmPass ? "instructions" : "offscreen"}>
