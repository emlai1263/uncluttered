  ...
  return (
    <div className="card flex text-gray-600 flex-col p-4 rounded-2xl drop-shadow-lg bg-white font-inter w-full">
      ...
      <div className="card-body">
        ...
        <h2 className="timeEst p-2.5 bg-gray-100 rounded-full">
          {timeEst} hours
        </h2>
        <p>{body}</p>
        <div className="flex justify-between mt-4">
          <button
            ...
            className="bg-white-500 hover:bg-gray-300 text-black py-2 px-4 rounded"
          >
            Recover
          </button>
          <button
            onClick={() => onPermanentDelete(taskId)}
            className="bg-gray-200 hover:bg-red-500 text-black py-2 px-4 rounded"
          >
            Delete Permanently
          </button>
        </div>
