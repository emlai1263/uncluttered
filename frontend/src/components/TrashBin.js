...
const TrashBin = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="relative w-2/5 bg-white p-5 rounded-lg shadow-lg">
        <div className="flex justify-between items-center mb-4 w-full">
          <header className="bg-white-500 text-black py-2 pl-2 rounded">
            Trash Bin
          </header>
          <div className="flex space-x-2">
            <button
              onClick={() => setShowConfirmModal(true)}
              className="bg-white-500 hover:bg-gray-200 text-black py-2 px-4 rounded"
            >
              Empty
            </button>
            ...
            <button
              onClick={onClose}
              className="bg-green-500 text-black py-2 pr-4 rounded"
            >
              Done
            </button>
          </div>
